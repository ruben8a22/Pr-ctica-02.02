...
cantidadPayasos = int(input("Cuantos payasos quieres?"))
cantidadMuñecas = int(input("Cuantas muñecas quieres?"))

pesoPaquete = (pesoPayaso * cantidadPayasos) + (pesoMuñeca * cantidadMuñecas)

print ("El peso total del paquete es", pesoPaquete)